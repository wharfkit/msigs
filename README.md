> [!IMPORTANT]
> This package lives in the WharfKit monorepo at [wharfkit/js/packages/msigs](https://github.com/wharfkit/js/tree/dev/packages/msigs), and this repository is archived. Open new issues and pull requests on [wharfkit/js](https://github.com/wharfkit/js).
